...
- Battle bug fixes applied: Burn reduces physical move damage only; burn residual remains 1/8 max HP; confusion self-hit chance is approximately 1/3; Berserk Gene confusion duration is initialized correctly; inflicted sleep duration is 1-3 turns while Rest remains fixed; freeze natural thaw chance is approximately 20 percent and existing Fire-move thaw interactions are preserved
