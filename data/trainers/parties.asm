...
JanineGroup:
	...
	db 36, WEEZING,    SLUDGE, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 36, WEEZING,    SLUDGE, SLUDGE_BOMB, TOXIC, EXPLOSION
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, FURY_CUTTER, RAGE
	...
	db 32, BEEDRILL,   FURY_ATTACK, PURSUIT, FURY_CUTTER, DOUBLE_TEAM
...
FisherGroup:
	...
	db 35, QWILFISH,   TOXIC, MINIMIZE, SURF, POISON_STING
	...
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 37, QWILFISH,   ROLLOUT, SURF, POISON_STING, TAKE_DOWN
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     BUBBLE, LEER, STOMP, HARDEN
	db 20, KRABBY,     BUBBLEBEAM, LEER, STOMP, HARDEN
	db -1 ; end
...
BlaineGroup:
	...
	db 45, MAGCARGO,   CURSE, SMOKESCREEN, FLAMETHROWER, ROCK_SLIDE
...
ExecutiveMGroup:
	...
	db 35, HOUNDOOM,   EMBER, ROAR, BITE, FAINT_ATTACK
	db -1 ; end
	...
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    TACKLE, POISON_GAS, SLUDGE, SMOKESCREEN
	db -1 ; end
